...
const FeatureItem: NextPage<FeatureItemType> = ({
  ...
  title,
  description,
  badgeClassName = "h-[3rem] w-[3rem] rounded-[40px] bg-[#1a8cd5]",
    ...
    >
      ...
      >
        {icon ? (
          ...
          <h3 className="m-0 relative text-[length:inherit] leading-[1.75rem] font-extrabold font-[inherit] text-color-white shrink-0 mq450:text-[1rem] mq450:leading-[1.375rem]">
            {number}
          </h3>
        )}
      </div>
      <div
        className={`flex-1 flex flex-col items-start gap-[0.5rem] font-abel ${vertical ? "" : "min-w-[21.375rem] mq750:min-w-full"} ${titleColor}`}
      >
