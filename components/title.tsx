  ...
  const [frameComponent1Items] = useState([
    {
      ...
      newsmax: "fundheadline",
      url: "http://fundheadline.com",
    },
    {
      property1: "Variant4" as const,
      networkOverflow: "hidden" as const,
