    ...
    >
      <div className="self-stretch rounded-3xl bg-[#0461c3] flex items-center p-[3.75rem] box-border relative isolate gap-[5rem] max-w-full mq450:gap-[1.25rem] mq450:pt-[2.438rem] mq450:pb-[2.438rem] mq450:box-border mq800:gap-[2.5rem] mq1350:flex-wrap mq1350:pl-[1.875rem] mq1350:pr-[1.875rem] mq1350:box-border">
        ...
        <Image
          ...
          src="/Vector-3.svg"
        />
        <section className="flex-1 flex flex-col items-start gap-[1.75rem] min-w-[23.938rem] z-[2] shrink-0 text-left text-[2.25rem] text-color-white font-['Proxima_Nova'] mq800:min-w-full">
...
"
        ...
        <div className="h-[14.438rem] w-[26.938rem] relative [filter:drop-shadow(0px_2px_80px_rgba(26,_38,_48,_0.08))] max-w-full z-[1] shrink-0 mq1125:min-w-full mq1350:flex-1">
