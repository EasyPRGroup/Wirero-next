...
const Agencies: NextPage<AgenciesType> = ({
  className = "",
  solarglobalBoldIconMaxHeight,
  solarglobalBoldIconHeight,
  dedicatedProjectMa,
  withLotsOfUnique,
}) => {
  const solarglobalBoldIconStyle: CSSProperties = useMemo(() => {
    return {
      maxHeight: solarglobalBoldIconMaxHeight,
      height: solarglobalBoldIconHeight,
    };
  }, [solarglobalBoldIconMaxHeight, solarglobalBoldIconHeight]);
  ...
  return (
    ...
    >
      <div className="self-stretch h-[10rem] flex items-center justify-center relative isolate">
        <div className="!!m-[0 important] absolute top-[-0.625rem] left-[-0.625rem] flex flex-col items-start z-[0] shrink-0">
        ...
        <div className="h-[4.75rem] w-[25rem] absolute !!m-[0 important] bottom-[0rem] left-[calc(50%_-_199.5px)] [background:linear-gradient(180deg,_rgba(255,_255,_255,_0.3)_10%,_rgba(255,_255,_255,_0.96)_27.95%)] z-[1] shrink-0" />
        <div className="shadow-[0px_4px_0px_rgba(26,_37,_48,_0.1)] rounded-3xl bg-color-white flex items-center p-[0.5rem] z-[2] shrink-0">
          <div className="h-[5rem] w-[5rem] rounded-2xl bg-[#1a8cd5] flex items-center justify-center p-[1.25rem] box-border">
            <Image
              ...
              style={solarglobalBoldIconStyle}
            />
          </div>
        </div>
      </div>
