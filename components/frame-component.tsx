...
const FrameComponent: NextPage<FrameComponentType> = ({
  ...
  return (
    ...
    >
      <div className="w-[22.375rem] max-w-full shadow-[0px_0px_8px_rgba(26,_38,_48,_0.08)] rounded-xl bg-color-white border-color-white border-solid border-[4px] box-border overflow-hidden flex flex-col items-center py-[0.687rem] px-[1.25rem]">
