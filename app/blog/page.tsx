...
const Blog: NextPage = () => {
  return (
    <div className="w-full relative bg-color-white overflow-hidden flex flex-col items-start leading-[normal] tracking-[normal]">
      <main className="self-stretch flex flex-col items-center justify-center py-[6.125rem] px-[6.875rem] min-h-[60vh] mq800:py-[3.5rem] mq800:px-[3.438rem] mq450:py-[2.625rem] mq450:px-[1.25rem]">
