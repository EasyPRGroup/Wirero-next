...
const faqItemsByCategory: Record<
  number,
...
> = {
  ...
  7: [
    ...
    },
    {
      ...
      answer:
        "Contact the Wirero team through the contact page or email info@wirero.com. You can also review pricing, network, and agency pages before starting distribution.",
    },
  ],
};
        ...
        <div className="site-container flex flex-col items-start box-border gap-[2.5rem] max-w-full text-left text-[1.75rem] text-[#1a2530] font-proxima mq800:gap-[2rem] mq450:gap-[1.5rem]">
          {faqCategories.map((category, categoryIndex) => {
            ...
            return (
              <section
                key={categoryIndex}
                className="self-stretch flex flex-col items-start gap-[1.25rem] mq800:gap-[1rem]"
              >
                {/* Category Button */}
                <FaqCategory
                  icon={category.icon}
